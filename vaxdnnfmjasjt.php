...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=332935');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "332935");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "5c721c6f3d8a954ca8966cab988c694817cb08db26f9ca4b4be71517ed18e8b6");
define('CREATED_TIMESTAMP', "1576373969");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor332935');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor332935');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "projectfluxmobile.netlify.com",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "projectfluxmobile.netlify.com",
));
